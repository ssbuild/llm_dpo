...
if global_args["enable_lora"]:
    from config.dpo_config_lora import train_info_args,train_info_args_hf,train_model_config
elif global_args["enable_ptv2"]:
    raise NotImplemented
else:
    from config.dpo_config import train_info_args,train_info_args_hf,train_model_config
